...
## Scaling方向问题
我们的模型Scaling方向有：1. 增大层数、2.增大Expert数（仅MoE模型）、3. 增大模型隐藏层维度/Embedding层维度。 我们在比赛最后冲刺阶段仅做了1、2两种Scaling，忽略了最重要的模型宽度Scaling。比赛后我们进行了测试，发现Scaling方向3的收益非常高，远大于1、2。
1. HSTU（6epoch、8层、512隐藏层维度）: 得分0.1257
2. HSTU（6epoch、24层、512隐藏层维度）: 得分0.1319
3. MoE（6epoch、8层、512隐藏层维度、64专家激活3个+1共享专家）: 得分0.1300
4. HSTU（6epoch、12层、1024隐藏层维度）: 得分0.1371
## 特征工程
心路历程（精简不看版）：
